...
git remote add aicrowd git@gitlab.aicrowd.com:<YOUR_AICROWD_USER_NAME>/mosquitoalert-2023-phase2-starter-kit.git 
...
`https://gitlab.aicrowd.com/<YOUR_AICROWD_USER_NAME>/mosquitoalert-2023-phase2-starter-kit/issues`
